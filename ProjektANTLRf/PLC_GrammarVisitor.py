...
class PLC_GrammarVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by PLC_GrammarParser#stat.
    def visitStat(self, ctx:PLC_GrammarParser.StatContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by PLC_GrammarParser#assignement.
    def visitAssignement(self, ctx:PLC_GrammarParser.AssignementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by PLC_GrammarParser#concatExpression.
    def visitConcatExpression(self, ctx:PLC_GrammarParser.ConcatExpressionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by PLC_GrammarParser#orExpression.
    def visitOrExpression(self, ctx:PLC_GrammarParser.OrExpressionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by PLC_GrammarParser#andExpression.
    def visitAndExpression(self, ctx:PLC_GrammarParser.AndExpressionContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by PLC_GrammarParser#forCondition.
    def visitForCondition(self, ctx:PLC_GrammarParser.ForConditionContext):
        return self.visitChildren(ctx)
