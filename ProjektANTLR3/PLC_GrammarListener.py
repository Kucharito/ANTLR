...
class PLC_GrammarListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by PLC_GrammarParser#ternaryOperator.
    def enterTernaryOperator(self, ctx:PLC_GrammarParser.TernaryOperatorContext):
        pass

    # Exit a parse tree produced by PLC_GrammarParser#ternaryOperator.
    def exitTernaryOperator(self, ctx:PLC_GrammarParser.TernaryOperatorContext):
        pass
