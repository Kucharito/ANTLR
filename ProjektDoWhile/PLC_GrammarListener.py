...
class PLC_GrammarListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by PLC_GrammarParser#doWhileCondition.
    def enterDoWhileCondition(self, ctx:PLC_GrammarParser.DoWhileConditionContext):
        pass

    # Exit a parse tree produced by PLC_GrammarParser#doWhileCondition.
    def exitDoWhileCondition(self, ctx:PLC_GrammarParser.DoWhileConditionContext):
        pass
